...
def DPN1(input_shape=None,
          include_top=True,
          weights=None,
          input_tensor=None,
          pooling=None,
          classes=1000):
    return DualPathNetwork(input_shape, initial_conv_filters=96, depth=[1, 1, 1, 1], filter_increment=[16, 32, 32, 128],
                           cardinality=40, width=4, include_top=include_top, weights=None,
                           pooling=pooling, classes=classes)
...
if __name__ == '__main__':
    model = DPN1((224, 224, 3))
    model.summary()
    plot_model(model, "dpn.png", show_shapes=True, show_layer_names=True)
